...
public class BottomView {
	...
	public static void main(String[] args) {
		...
		bottomView.printBottom(root);
	}

	// Function to print the bottom view of a given binary tree
	public static void printBottom(Node root) {
		/*
		 * Create a `TreeMap` where key —> relative horizontal distance of the node from
		 * the root node, and value —> pair containing the node's value and its level
		 */
